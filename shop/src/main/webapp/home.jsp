...
<body>
    ...
    <div>
        <c:forEach var="index" begin="0" end="${sessionScope.treeCategoryList.size()-1}">
                <a href="show-servlet?id=${sessionScope.treeCategoryList.get(index).id}">
    ...
    <div>
        ...
        <c:forEach var="index2" begin="0" end="${sessionScope.secondCategoryList.size()-1}">
            <a href="show-servlet?id=${sessionScope.secondCategoryList.get(index2).id}">
    ...
    <div>
        ...
        <c:forEach var="index3" begin="0" end="${sessionScope.thirdCategoryList.size()-1}">
            <a href="show-servlet?id=${sessionScope.thirdCategoryList.get(index3).id}">
