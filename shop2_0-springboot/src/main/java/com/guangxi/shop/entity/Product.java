...
public class Product {
    ...
    public Product(String id, String name, BigDecimal price, String category_id, int sort, int sales, String cover, int status, int is_deleted, Timestamp create_time, Timestamp update_time) {
        this.id = id;
        this.name = name;
        this.price = price;
